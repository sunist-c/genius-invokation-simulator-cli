...
type DescriptionTypeToStringAdapter struct {
	dictionary map[enum.DescriptionType]string
}

func (adapter *DescriptionTypeToStringAdapter) Convert(source enum.DescriptionType) (success bool, result string) {
	stringResult, exist := adapter.dictionary[source]
	return exist, stringResult
}

func NewDescriptionTypeToStringAdapter() adapter.Adapter[enum.DescriptionType, string] {
	return &DescriptionTypeToStringAdapter{
		dictionary: map[enum.DescriptionType]string{
			enum.DescriptionTypePlainText: "DescriptionTypePlainText",
			enum.DescriptionTypeHtml:      "DescriptionTypeHtml",
		},
	}
}

type StringToDescriptionTypeAdapter struct {
	dictionary map[string]enum.DescriptionType
}

func (adapter *StringToDescriptionTypeAdapter) Convert(source string) (success bool, result enum.DescriptionType) {
	descriptionTypeResult, exist := adapter.dictionary[source]
	return exist, descriptionTypeResult
}

func NewStringToDescriptionTypeAdapter() adapter.Adapter[string, enum.DescriptionType] {
	return &StringToDescriptionTypeAdapter{
		dictionary: map[string]enum.DescriptionType{
			"DescriptionTypePlainText": enum.DescriptionTypePlainText,
			"DescriptionTypeHtml":      enum.DescriptionTypeHtml,
		},
	}
}

// StringToSkillTypeAdapter generated by adapter.tpl
type StringToSkillTypeAdapter struct {
	dictionary map[string]enum.SkillType
}

func (adapter *StringToSkillTypeAdapter) Convert(source string) (success bool, result enum.SkillType) {
	descriptionTypeResult, exist := adapter.dictionary[source]
	return exist, descriptionTypeResult
}

// NewStringToSkillTypeAdapter generated by adapter.tpl
func NewStringToSkillTypeAdapter() adapter.Adapter[string, enum.SkillType] {
	return &StringToSkillTypeAdapter{
		dictionary: map[string]enum.SkillType{
			"SkillPassive":        enum.SkillPassive,
			"SkillNormalAttack":   enum.SkillNormalAttack,
			"SkillElementalSkill": enum.SkillElementalSkill,
			"SkillElementalBurst": enum.SkillElementalBurst,
			"SkillCooperative":    enum.SkillCooperative,
		},
	}
}

// SkillTypeToStringAdapter generated by adapter.tpl
type SkillTypeToStringAdapter struct {
	dictionary map[enum.SkillType]string
}

func (adapter *SkillTypeToStringAdapter) Convert(source enum.SkillType) (success bool, result string) {
	descriptionTypeResult, exist := adapter.dictionary[source]
	return exist, descriptionTypeResult
}

// NewSkillTypeToStringAdapter generated by adapter.tpl
func NewSkillTypeToStringAdapter() adapter.Adapter[enum.SkillType, string] {
	return &SkillTypeToStringAdapter{
		dictionary: map[enum.SkillType]string{
			enum.SkillPassive:        "SkillPassive",
			enum.SkillNormalAttack:   "SkillNormalAttack",
			enum.SkillElementalSkill: "SkillElementalSkill",
			enum.SkillElementalBurst: "SkillElementalBurst",
			enum.SkillCooperative:    "SkillCooperative",
		},
	}
}
